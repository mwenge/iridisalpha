...
;----------------------------------------------------------------------
        ...
        .BYTE $3C,$66,$C6,$DE,$C6,$04,$2B       ;.BYTE $3C,$66,$C6,$DE,$C6,$C6,$C6,$C6
                                                ; CHARACTER $01
                                                ; 00111100     ****  
                                                ; 01100110    **  ** 
                                                ; 11000110   **   ** 
        ...
        .BYTE $3C,$66,$C0,$04,$2B,$C6,$7C       ;.BYTE $3C,$66,$C0,$C0,$C0,$C0,$C6,$7C
                                                ; CHARACTER $03
                                                ; 00111100     ****  
                                                ; 01100110    **  ** 
                                                ; 11000000   **      
        ...
        .BYTE $F8,$CC,$C6,$04,$2B,$CC,$D8       ;.BYTE $F8,$CC,$C6,$C6,$C6,$C6,$CC,$D8
                                                ; CHARACTER $04
                                                ; 11111000   *****   
                                                ; 11001100   **  **  
                                                ; 11000110   **   ** 
        ...
        .BYTE $FE,$C0,$C0,$D8,$C0,$04,$2B       ;.BYTE $FE,$C0,$C0,$D8,$C0,$C0,$C0,$C0
                                                ; CHARACTER $06
                                                ; 11111110   ******* 
                                                ; 11000000   **      
                                                ; 11000000   **      
        ...
        .BYTE $C6,$C6,$C6,$DE,$C6,$04,$2B       ;.BYTE $C6,$C6,$C6,$DE,$C6,$C6,$C6,$C6
                                                ; CHARACTER $08
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
        ...
        .BYTE $3C,$18,$06,$2B,$3C               ;.BYTE $3C,$18,$18,$18,$18,$18,$18,$3C
                                                ; CHARACTER $09
                                                ; 00111100     ****  
                                                ; 00011000      **   
                                                ; 00011000      **   
        ...
        .BYTE $3C,$18,$05,$2B,$30,$60           ;.BYTE $3C,$18,$18,$18,$18,$18,$30,$60
                                                ; CHARACTER $0a
                                                ; 00111100     ****  
                                                ; 00011000      **   
                                                ; 00011000      **   
        ...
        .BYTE $C0,$07,$2B,$DE                   ;.BYTE $C0,$C0,$C0,$C0,$C0,$C0,$C0,$DE
                                                ; CHARACTER $0c
                                                ; 11000000   **      
                                                ; 11000000   **      
                                                ; 11000000   **      
        ...
        .BYTE $FE,$DB,$04,$2B,$C3,$C3,$C3       ;.BYTE $FE,$DB,$DB,$DB,$DB,$C3,$C3,$C3
                                                ; CHARACTER $0d
                                                ; 11111110   ******* 
                                                ; 11011011   ** ** **
                                                ; 11011011   ** ** **
        ...
        .BYTE $FC,$C6,$07,$2B                   ;.BYTE $FC,$C6,$C6,$C6,$C6,$C6,$C6,$C6
                                                ; CHARACTER $0e
                                                ; 11111100   ******  
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
        ...
        .BYTE $7C,$C6,$06,$2B,$5C               ;.BYTE $7C,$C6,$C6,$C6,$C6,$C6,$C6,$5C
                                                ; CHARACTER $0f
                                                ; 01111100    *****  
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
        ...
        .BYTE $FC,$C6,$C6,$DC,$C0,$04,$2B       ;.BYTE $FC,$C6,$C6,$DC,$C0,$C0,$C0,$C0
                                                ; CHARACTER $10
                                                ; 11111100   ******  
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
        ...
        .BYTE $7E,$18,$07,$2B                   ;.BYTE $7E,$18,$18,$18,$18,$18,$18,$18
                                                ; CHARACTER $14
                                                ; 01111110    ****** 
                                                ; 00011000      **   
                                                ; 00011000      **   
        ...
        .BYTE $C6,$07,$2B,$FC                   ;.BYTE $C6,$C6,$C6,$C6,$C6,$C6,$C6,$FC
                                                ; CHARACTER $15
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
        ...
        .BYTE $C6,$06,$2B,$6C,$38               ;.BYTE $C6,$C6,$C6,$C6,$C6,$C6,$6C,$38
                                                ; CHARACTER $16
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
                                                ; 11000110   **   ** 
        ...
        .BYTE $C3,$C3,$C3,$DB,$04,$2B,$FE       ;.BYTE $C3,$C3,$C3,$DB,$DB,$DB,$DB,$FE
                                                ; CHARACTER $17
                                                ; 11000011   **    **
                                                ; 11000011   **    **
                                                ; 11000011   **    **
        ...
        .BYTE $C6,$6C,$38,$04,$2B,$6C,$C6,$04,$2B  ;.BYTE $C6,$6C,$38,$38,$38,$38,$6C,$C6
                                                ; CHARACTER $18
                                                ; 11000110   **   ** 
                                                ; 01101100    ** **  
                                                ; 00111000     ***   
        ...
        .BYTE $00,$78,$60,$04,$2B,$78,$00       ;.BYTE $00,$78,$60,$60,$60,$60,$78,$00
                                                ; CHARACTER $1b
                                                ; 00000000           
                                                ; 01111000    ****   
                                                ; 01100000    **     
        ...
        .BYTE $00,$78,$18,$04,$2B,$78,$00       ;.BYTE $00,$78,$18,$18,$18,$18,$78,$00
                                                ; CHARACTER $1d
                                                ; 00000000           
                                                ; 01111000    ****   
                                                ; 00011000      **   
        ...
        .BYTE $00,$18,$3C,$7E,$00,$05,$2B       ;.BYTE $00,$18,$3C,$7E,$00,$00,$00,$00
                                                ; CHARACTER $1e
                                                ; 00000000           
                                                ; 00011000      **   
                                                ; 00111100     ****  
        ...
        .BYTE $10,$30,$70,$70,$30,$10,$00,$09,$2B  ;.BYTE $00,$10,$30,$70,$70,$30,$10,$00
                                                ; CHARACTER $1f
                                                ; 00000000           
                                                ; 00010000      *    
                                                ; 00110000     **    
        ...
        .BYTE $68,$05,$2B                       ;.BYTE $00,$00,$00,$00,$00,$00,$00,$00
                                                ; CHARACTER $20
                                                ; 00000000           
                                                ; 00000000           
                                                ; 00000000           
        ...
        .BYTE $36,$36,$00,$07,$2B               ;.BYTE $36,$36,$00,$00,$00,$00,$00,$00
                                                ; CHARACTER $22
                                                ; 00110110     ** ** 
                                                ; 00110110     ** ** 
                                                ; 00000000           
        ...
        .BYTE $0C,$18,$00,$06,$2B               ;.BYTE $0C,$18,$00,$00,$00,$00,$00,$00
                                                ; CHARACTER $27
                                                ; 00001100       **  
                                                ; 00011000      **   
                                                ; 00000000           
        ...
        .BYTE $18,$30,$60,$04,$2B,$30,$18       ;.BYTE $18,$30,$60,$60,$60,$60,$30,$18
                                                ; CHARACTER $28
                                                ; 00011000      **   
                                                ; 00110000     **    
                                                ; 01100000    **     
        ...
        .BYTE $30,$18,$0C,$04,$2B,$18,$30       ;.BYTE $30,$18,$0C,$0C,$0C,$0C,$18,$30
                                                ; CHARACTER $29
                                                ; 00110000     **    
                                                ; 00011000      **   
                                                ; 00001100       **  
        ...
        .BYTE $00,$06,$2B,$30,$60               ;.BYTE $00,$00,$00,$00,$00,$00,$30,$60
                                                ; CHARACTER $2c
                                                ; 00000000           
                                                ; 00000000           
                                                ; 00000000           
        ...
        .BYTE $00,$24,$66,$FF,$FF,$66,$24,$00,$07,$2B  ;.BYTE $00,$24,$66,$FF,$FF,$66,$24,$00
                                                ; CHARACTER $2d
                                                ; 00000000           
                                                ; 00100100     *  *  
                                                ; 01100110    **  ** 
        ...
        .BYTE $78,$78,$00,$38,$05,$2B           ;.BYTE $78,$78,$00,$38,$38,$38,$38,$38
                                                ; CHARACTER $31
                                                ; 01111000    ****   
                                                ; 01111000    ****   
                                                ; 00000000           
        ...
        .BYTE $FE,$FE,$00,$06,$05,$2B           ;.BYTE $FE,$FE,$00,$06,$06,$06,$06,$06
                                                ; CHARACTER $37
                                                ; 11111110   ******* 
                                                ; 11111110   ******* 
                                                ; 00000000           
        ...
        .BYTE $00,$00,$7E,$00,$7E,$00,$04,$2B   ;.BYTE $00,$00,$7E,$00,$7E,$00,$00,$00
                                                ; CHARACTER $3d
                                                ; 00000000           
                                                ; 00000000           
                                                ; 01111110    ****** 
        ...
        .BYTE $3C,$66,$06,$0C,$18,$18,$00,$04,$2B  ;.BYTE $3C,$66,$06,$0C,$18,$18,$00,$00
                                                ; CHARACTER $3f
                                                ; 00111100     ****  
                                                ; 01100110    **  ** 
                                                ; 00000110        ** 
        ...
        .BYTE $20,$00,$88,$00,$22,$00,$55                 ; $1061:                     
...
b12B2   =*+$01
        BNE b12B9
        DEC a036D ; This is the low byte on f2441 above
        DEC a038C ; This is the low byte on f2441 below
...
b12C4   LDA (CharSetPtrLo),Y
        ...
        BNE b12BD
        DEC a036D ; This is the low byte on f2441 above
        DEC a038C ; This is the low byte on f2441 above
        BNE b12BD
